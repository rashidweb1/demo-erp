...
class Public_leads_api extends AdminController
{
    ...
    public function index()
    {
        ...
        if ($this->input->post('action') === 'settings') {
            ...
            $allowedDomains = trim((string) $this->input->post('allowed_domains'));
            ...
            update_option('public_leads_api_allowed_domains', $allowedDomains);
        ...
        $data['allowed_domains'] = (string) get_option('public_leads_api_allowed_domains', '');
