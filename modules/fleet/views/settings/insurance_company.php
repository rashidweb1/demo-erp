...
<div>
	<a href="#" class="btn btn-info add-new-insurance-company mbot15"><?php echo _l('add'); ?></a>
</div>
<div class="row">
	<div class="col-md-12">
		<?php 
...
<div class="modal fade" id="insurance-company-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(admin_url('fleet/insurance_company'),array('id'=>'insurance-company-form'));?>
