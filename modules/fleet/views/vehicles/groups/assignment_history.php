...
<a href="#" onclick="add_vehicle_assignment(); return false;" class="btn btn-info mbot25"><?php echo _l('new'); ?></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo render_select('vehicle_id',$vehicles, array('id', 'name'),'vehicle', $vehicle->id); ?>
