    ...
    <div class="row">
      <div class="col-md-12">
        ...
        if(is_admin() || has_permission('fleet_inspection', '', 'create')){
         ?>
         <button class="btn btn-primary mbot20" onclick="add_inspections(); return false;"><?php echo _l('add'); ?></button>          
...
<div class="modal fade" id="add_new_inspections" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
     ...
     <?php echo form_open(admin_url('fleet/add_inspection/'.$vehicle->id),array('id'=>'inspections-form')); ?>
