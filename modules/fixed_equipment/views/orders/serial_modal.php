<div class="modal fade z-index-none" id="serialNumberModal">
	<div class="modal-dialog setting-transaction-table">
		<div class="modal-content">
			...
			<?php echo form_open(admin_url('fixed_equipment/serial_number_modal'), array('id' => 'serial_number_modal', 'autocomplete'=>'off')); ?>
			<div class="modal-body">
							...
							<table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
								<thead>
									<tr>
										...
										<th width="15%" align="left"><?php echo _l('fe_serial_number'); ?></th>
									</tr>
								</thead>
				...
				<?php echo new_html_entity_decode($table_serial_number); ?>
...
<?php require('modules/fixed_equipment/assets/js/orders/select_serial_number_modal_js.php'); ?>