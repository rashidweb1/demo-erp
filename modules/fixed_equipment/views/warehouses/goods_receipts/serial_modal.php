		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><?php echo new_html_entity_decode($title); ?></h4>
					<p class="text-danger"><?php echo _l('fe_serial_number_as_mandatory'); ?></p>
			</div>
			...
			<div class="modal-footer">
				...
				<a href="javascript:void(0)"class="btn btn-success pull-right mright10 display-block btn_auto_generate_serial_number" ><?php echo _l('fe_auto_generate_serial_numbers'); ?></a>
			</div>
...
<?php require('modules/fixed_equipment/assets/js/warehouses/fill_multiple_serial_number_js.php'); ?>