...
if(isset($accessory)){
	...
	$unit_price = app_format_money($accessory->unit_price, '');
	$date_buy = _d($accessory->date_buy);
	$quantity = $accessory->quantity;
	$min_quantity = $accessory->min_quantity;
	$model_no = $accessory->model_no;
	$for_sell = $accessory->for_sell;   
	$for_rent = $accessory->for_rent;   
	$selling_price = app_format_money($accessory->selling_price, '');   
	$rental_price = app_format_money($accessory->rental_price, '');   
}
