    ...
    <div class="panel_s">
        <div class="panel-body">
           <div class="col-md-12 head-order">
              <div class="col-md-6">
                  <h5><?php echo _l('order_number');  ?>: #<?php  echo fe_htmldecode($value['order_number']); ?></h5>
                  <span><?php echo _l('order_date');  ?>: <?php  echo fe_htmldecode($value['datecreator']); ?></span>
              </div>
              <div class="col-md-6">
                   ...
                   <div class="col-md-8">                      				 
                       <a href="#">		
                        ...
                        <strong class="product_name">
                            <?php echo fe_htmldecode($item['product_name']); ?>			                                    
                        </strong>
                    </a>
                </div> 
                <div class="col-md-4">
