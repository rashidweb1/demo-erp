			...
			<div class="col-md-12">
				...
				<ul class="nav nav-tabs  tabs" role="tablist">
					...
					<?php if(isset($packing_lists) && count($packing_lists) > 0){ ?>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#packing_list" role="tab" aria-selected="false"><strong><?php echo _l('fe_packing_list'); ?></strong></a>
						</li>
					<?php } ?>
				</ul>
				<!-- Tab panes -->
													...
													foreach ($goods_delivery as $key => $delivery_note) {
														...
														<tr>
															<td >
																...
																$delivery_url = '';
																if(!is_staff_logged_in()){
																	$profile_url = site_url('fixed_equipment/fixed_equipment_client/view_staff_profile/' . urlencode(fe_aes_256_encrypt($delivery_note['staff_id'])));

																	$delivery_url = site_url('fixed_equipment/fixed_equipment_client/view_delivery_voucher/' .app_generate_hash().'_'.$delivery_note['id']);
																...
																?>
																<a href="<?php echo fe_htmldecode($delivery_url); ?>" ><?php echo fe_htmldecode($delivery_note['goods_delivery_code']) ?></a>
															</td>
															...
															<td class="text-right">
																...
																<td class="text-right"><?php echo fe_render_delivery_status_html($delivery_note['id'], 'delivery', $delivery_note['delivery_status'], false); ?></td>
															</tr>
														<?php  } ?>
													</tbody>
												</table>
												...
												<table class="table items items-preview estimate-items-preview" data-type="estimate">
													<thead>
														<tr>
															...
															<th align="right" colspan="1"><?php echo _l('fe_total_amount') ?></th>
															...
															<th align="right" colspan="1"><?php echo _l('fe_status') ?></th>
															<th align="right" colspan="1"><?php echo _l('delivery_status') ?></th>
														</tr>
													</thead>
													<tbody class="ui-sortable">
