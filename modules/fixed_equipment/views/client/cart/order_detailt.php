               ...
               <div class="panel-body">
                ...
                <div>
                  ...
                  <div class="tab-content mtop10">
                     <?php
                     $this->load->view('client/cart/shipment_order');                            
                     ?>
                  </div>
                  <div class="row">
                     <div class="col-md-12 mtop15">
                        <a href="<?php echo site_url('fixed_equipment/fixed_equipment_client/index/1/0/0'); ?>" class="btn btn-default"><?php echo _l('fe_continue_shopping'); ?></a>
                        <?php  if($status_key == 'draft'){ ?>
                         <button class="btn btn-primary pull-right" onclick="open_modal_chosse();">
                          <?php echo _l('cancel_order'); ?>
                       </button>    
                    <?php } ?>   
                    <?php  if(fe_can_refund_order($order->id)){ ?>
                       <button class="btn btn-primary pull-right" onclick="open_refund_modal();">
                        <?php echo _l('fe_request_a_refund'); ?>
                     </button>   
                  <?php } ?>                  
               </div>
            </div>
