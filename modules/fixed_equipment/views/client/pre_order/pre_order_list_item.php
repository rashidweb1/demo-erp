...
<table class="table dt-table" >
    ...
    <tbody>
    	<?php foreach($pre_oreders as $key => $order){ ?>
    		<tr>
    			<td class="hide"><?php echo fe_htmldecode($key); ?></td>
    			<td><a href="<?php echo site_url('omni_sales/omni_sales_client/view_order_detail/'.$order['order_number']); ?>" target="_blank"><?php echo fe_htmldecode($order['order_number']); ?></a></td>
