...
<div class="panel_s invoice accounting-template">
 ...
 <div class="panel-body">
  ...
  <div class="row">
   <div class="col-md-12">
     <hr class="hr-10" />
     <a href="<?php echo site_url('/omni_sales/omni_sales_client/client_info_pre_order/'.$userid); ?>" class="edit_shipping_billing_info" ><i class="fa fa-pencil-square"></i></a>
   </div>
   <div class="col-md-6">
...
<div class="col-md-8 col-md-offset-4">
 <table class="table text-right">
  <tbody>
    ...
    ?>
    <tr class="<?php echo fe_htmldecode($hide_shipping) ?>">
      <td><span class="bold"><?php echo _l('omni_shipping_fee'); ?> :</span>
         <input type="hidden" name="shipping" value="<?php echo fe_htmldecode($shipping_fee); ?>">
      </td>
      <td id="shipping_fee">
      </td>
    </tr>
